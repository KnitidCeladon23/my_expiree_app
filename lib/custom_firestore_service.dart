...
class DatabaseService<T> {
  ...
  Stream<List<T>> streamList(String userid) {
    var ref = _db.collection('inventoryLists').document(userid).collection('indivInventory');
  ...
  Future<void> updateData(String id, String userid, Map<String, dynamic> data) {
    return _db.collection('inventoryLists').document(userid).collection('indivInventory').document(id).updateData(data);
  }
